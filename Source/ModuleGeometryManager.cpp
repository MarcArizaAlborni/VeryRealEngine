...
void ModuleGeometryManager::DrawGwyn()
{
	...
	uint sizel;
	sizel=App->meshimporter->MeshesOnScene.size() -1;
	
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(0)->TextureData = App->textureImporter->GwynSword;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(1)->TextureData = App->textureImporter->GwynAccessories;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(2)->TextureData = App->textureImporter->GwynSword;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(3)->TextureData = App->textureImporter->GwynClothesB;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(4)->TextureData = App->textureImporter->GwynClothes;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(5)->TextureData = App->textureImporter->GwynAccessories;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(6)->TextureData = App->textureImporter->GwynClothesB;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(7)->TextureData = App->textureImporter->GwynClothes;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(8)->TextureData = App->textureImporter->GwynClothes;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(9)->TextureData = App->textureImporter->GwynClothesB;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(10)->TextureData = App->textureImporter->GwynAccessories;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(11)->TextureData = App->textureImporter->GwynSkin;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(12)->TextureData = App->textureImporter->GwynAccessories;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(13)->TextureData = App->textureImporter->GwynCrown;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(14)->TextureData = App->textureImporter->GwynCrown;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(15)->TextureData = App->textureImporter->GwynClothesC;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(16)->TextureData = App->textureImporter->GwynAccessories;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(17)->TextureData = App->textureImporter->GwynClothesC;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(18)->TextureData = App->textureImporter->GwynClothesB;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(19)->TextureData = App->textureImporter->GwynClothesC;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(20)->TextureData = App->textureImporter->GwynHair;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(21)->TextureData = App->textureImporter->GwynHair;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(22)->TextureData = App->textureImporter->GwynHair;
	App->meshimporter->MeshesOnScene.at(sizel)->ChildObjects.at(23)->TextureData = App->textureImporter->GwynHair;
}
