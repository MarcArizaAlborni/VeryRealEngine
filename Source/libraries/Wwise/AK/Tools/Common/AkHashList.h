...
#include "libraries/Wwise/AK/Tools/Common/AkKeyDef.h"// for MapStruct
#include "libraries/Wwise/AK/Tools/Common/AkObject.h"
#include "libraries/Wwise/AK/Tools/Common/AkArray.h"
