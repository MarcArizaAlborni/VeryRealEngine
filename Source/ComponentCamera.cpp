...
ComponentCamera::ComponentCamera(Application* app, const char* name, bool start_enabled) : Module(app, "Texture Importer", start_enabled)
{
...
{
	//Cube Vertex
	glGenBuffers(1, (GLuint*) &(id_vertices_frustum));
